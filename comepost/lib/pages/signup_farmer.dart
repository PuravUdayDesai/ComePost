...
class _SignUpFarmerState extends State<SignUpFarmer> {
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF10'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF10'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF10')
                        : null,
                  ),
                ),
                Padding(
  ...
  addData() async {
    ...
    print(s1.toMap());
    Farmer u2 = await createRecord(s1.toMap());
    print("User Created");
    setState(() {
      isLoading = false;
    });
