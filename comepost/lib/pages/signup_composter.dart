...
class Composter {
  ...
  factory Composter.fromJson(Map<String, dynamic> json) {
    ...
    return Composter(0, _first_name, _last_name, _company_id, _company_name,
        _designation, _email, _contact, _dob, _dob2, _dob3, _dob4);
  }
  Map toMap() {
...
class _SignUpComposterState extends State<SignUpComposter> {
  ...
  DateTime convertToDate(String input) {
    ...
    print("date = " + input);
    try {
      var d = new DateFormat.yMd()
          .parseStrict(parse[1] + "/" + parse[0] + "/" + parse[2]);
      print(d);
      return d;
    } catch (e) {
      print(e);
        ...
        DialogButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).pushNamedAndRemoveUntil(
                '/selection_screen_login', ModalRoute.withName('/'));
          },
          width: 120,
        )
      ],
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF2'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF2'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF2')
                        : null,
                  ),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) => isValidEmail(value)
                        ? (isEmailContains(value)
                            ? null
                            : AppLocalizations.of(context)
                                .translate('signUpErr1F4'))
                        : AppLocalizations.of(context)
                            .translate('signUpErr2F4'),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF5'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF5'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF5')
                        : null,
                  ),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF6'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF6'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF6')
                        : null,
                  ),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      icon: Icon(Icons.business),
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF7'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF7'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF7')
                        : null,
                  ),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      icon: Icon(Icons.business),
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF8'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF8'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF8')
                        : null,
                  ),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      icon: Icon(Icons.business),
                      hintText: AppLocalizations.of(context)
                          .translate('signUpHintF9'),
                      labelText:
                          AppLocalizations.of(context).translate('signUpF9'),
                    ),
                    validator: (val) => val.isEmpty
                        ? AppLocalizations.of(context).translate('signUpErrF9')
                        : null,
                  ),
                ),
                Container(
  ...
  addData() async {
    ...
    Composter u2 = await createRecord(s1.toMap());
    print("User Created");
    print(s1.toMap());
    setState(() {
      isLoading = false;
